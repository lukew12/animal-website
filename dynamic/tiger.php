<?php
  $animal = "tigers";
  $animal_image_path = "images/Male_Tiger_Ranthambhore.jpg";
  $animal_description = "The tiger (Panthera tigris) is the largest species among the Felidae and classified in the genus Panthera. 
  ...
  before they become independent and leave their mother's home range to establish their own.";
  include('_header.php');
  include('_main.php');
  include('_footer.php');
?>
